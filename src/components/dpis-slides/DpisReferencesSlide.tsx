...
export function DpisReferencesSlide() {
  return (
      ...
      >
        ...
        >
          <div className="flex items-center justify-center mb-4">
            ...
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-800">
              Referências - Doença Intersticial
            </h1>
          </div>
        ...
        >
          <div className="space-y-4 text-sm lg:text-base text-gray-700 leading-relaxed">
            <p className="border-l-4 border-blue-200 pl-6 py-4 bg-blue-50/50 rounded-r-lg hover:bg-blue-50 transition-colors duration-300">
              <strong className="text-blue-700">1.</strong> ALTHOBIANI, M. A. et al. Interstitial lung disease: a review of classification, etiology, epidemiology, clinical diagnosis, pharmacological and non-pharmacological treatment. <em>Front Med (Lausanne)</em>, v. 11, 18 abr. 2024
            </p>
            ...
            <p className="border-l-4 border-indigo-200 pl-6 py-4 bg-indigo-50/50 rounded-r-lg hover:bg-indigo-50 transition-colors duration-300">
              <strong className="text-indigo-700">2.</strong> WIJSENBEEK, M.; SUZUKI, A.; MAHER, T. M. Interstitial lung diseases. <em>The Lancet</em>, v. 400, n. 10354, p. 769–786, set. 2022.
            </p>
          </div>
        </motion.div>
        ...
        >
          <p className="text-sm text-gray-500">
            Referências bibliográficas utilizadas no estudo das Doenças Pulmonares Intersticiais
          </p>
        </motion.div>
      </motion.div>
    </div>
