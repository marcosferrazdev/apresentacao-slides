...
const slides = [
  { id: 1, component: AtelectasiaTitleSlide },
  { id: 2, component: AlveolarStabilitySlide },
  { id: 3, component: ClassificationSlide },
  { id: 4, component: PostOperativeSlide },
  { id: 5, component: PathophysiologySlide },
  { id: 6, component: RadiologySlide },
  { id: 7, component: AtelectasiaConclusionSlide },
];
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-gradient-to-br from-blue-50 via-white to-slate-50">
      ...
      <EndPresentationModal
        ...
        presentationTitle="Atelectasia: Fisiopatologia e Implicações Clínicas"
      />
    </div>
  );
}