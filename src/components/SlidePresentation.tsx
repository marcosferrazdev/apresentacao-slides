...
import { DefenseSlide } from "./slides/DefenseSlide";
import { InfectionSlide } from "./slides/InfectionSlide";
import { InflammatorySlide } from "./slides/InflammatorySlide";
import { ConsolidationSlide } from "./slides/ConsolidationSlide";
...
const slides = [
  ...
  { id: 2, component: DefenseSlide },
  { id: 3, component: InfectionSlide },
  { id: 4, component: InflammatorySlide },
  { id: 5, component: ConsolidationSlide },
  { id: 6, component: ClinicalSlide },
...
export function SlidePresentation({ onGoHome }: SlidesPresentationProps) {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-gradient-to-br from-blue-50 via-white to-slate-50">
      ...
      <EndPresentationModal
        ...
        presentationTitle="Fisiopatologia da Pneumonia: Uma Abordagem Integrada"
      />
    </div>
  );
}